...
2. The agent fetches surface-level metadata for that listing (name, developer, icon, category, country) and confirms with the user: _"Is this the app you meant?"_
